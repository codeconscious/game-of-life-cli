...
public class Settings : IGridSettings
{
    ...
    private static byte MinimumWidthHeight => 5;
    ...
    public Settings(SettingsDto? dto, IPrinter printer)
    {
        ...
        if (dto.Width < 0)
        {
            ...
            Width = WindowWidth == 0 // This can occur when debugging.
                ? 200 // Debugging value
                : autoWidth;
        }
        else
        ...
        if (dto.Height < 0)
        {
            ...
            int autoHeight = WindowHeight - bottomMargin;
            ...
            Height = WindowHeight == 0 // This can occur when debugging.
                ? 30 // Debugging value
                : autoHeight;
        }
        else
